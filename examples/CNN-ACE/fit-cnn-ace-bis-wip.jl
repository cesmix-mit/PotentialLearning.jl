...
#   julia> include("fit-cnn-ace-bis-wip.jl")
...
args = ["experiment_path",      "a-HfO2-CNN-ACE-BIS-WIP/",
...
function PotentialLearning.potential_energy(c::Configuration, nniap::NNIAP)
